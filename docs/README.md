...
Entrag是一个基于检索增强生成（RAG）技术的问答系统，使用以下技术栈构建：
...
2. **查询流程**
   ```
   用户问题 → 问题向量化 → 向量相似度搜索 → 检索相关文档 → LLM生成回答
   ```
...
./entrag ask "How do I define relationships in Ent?"
...
- **聊天模型**: llama3.1, qwen2.5, mistral, deepseek-r1
